---
title: 'O que é Data Science, afinal?'
date: '2023-09-04'
tags: ['Data Science', 'Carreira']
excerpt: "Aposto que você já ouviu falar sobre Data Science. Mas você realmente entende o que é? Neste post, vamos explorar essa área e suas aplicações."
lang: 'pt'
readTime: '3 min'
reference: 'so-what-is-data-science'
---
...
> _"Um cientista de dados é alguém que é melhor em estatística do que qualquer engenheiro de software e melhor em engenharia de software do que qualquer estatístico."_
>
> — Josh Wills
...
![Fluxo de Data Science](https://naomilago.com/assets/data-science-workflow.png)

<br>

Data Science geralmente é composta pelas seguintes etapas:

1. **Coleta de dados** — obtenção de dados brutos a partir de diversas fontes  
2. **Limpeza de dados** — tratamento de valores ausentes, outliers e inconsistências  
3. **Análise exploratória** — compreensão de padrões e distribuições  
4. **Modelagem** — construção de modelos preditivos ou descritivos  
5. **Comunicação** — apresentação de insights para stakeholders  
